#!/usr/bin/env python3
"""
Quick wrapper to run batch backtests from project root.
"""
...
# Now import and run batch_runner code inline
import pandas as pd
import numpy as np
from pathlib import Path
...
from stock_ai.backtests.backtest_runner import run_backtest, calculate_metrics
from stock_ai.backtests.data_loader import load_ohlcv
import stock_ai.strategies.ma_crossover as ma_crossover
import stock_ai.strategies.rsi_filter as rsi_filter
import stock_ai.strategies.bollinger_reversion as bollinger_reversion
import stock_ai.strategies.ensemble_vote as ensemble_vote
